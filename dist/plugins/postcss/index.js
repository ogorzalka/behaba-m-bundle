...
exports['default'] = function (options) {
  ...
  var processor = function processor(contents, callback) {
    try {
      (0, _postcss2['default'])().use((0, _postcssSvgFallback2['default'])(options['svg_fallback'])).use(_postcssMoveMedia2['default']).use(_autoprefixer2['default']).process(contents).then(function (processor) {
